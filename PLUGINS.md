...
Individual skills from these plugins are also available in the [Alex ACT Plugin Mall](https://github.com/fabioc-aloha/Alex_Skill_Mall). Use `/mall install` for individual skills; use plugin registration for the full agent experience.
