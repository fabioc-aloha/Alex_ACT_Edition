...
| Infrastructure and Fleet | Mall plugin management, heir health, API auditing, status reporting, AI-Memory setup | mall-installation, ai-memory-setup, /mall-search, /mall-install, /mall-refresh, /mall-contribute, /status |

34 instructions, 17 skills, 21 prompts, 3 agents, 21 muscles. Always-on token budget: 13,886 / 15,000 (92.6%).
