...
console.log('━'.repeat(72));
console.log('');
console.log('  ✓ Brain installed at .github/');
console.log('  ✓ Heir marker rendered at .github/.act-heir.json');
console.log('  ✓ heir-doctor ran (see output above)');
console.log('');
console.log('  Next:');
console.log('');
console.log('    1. Edit .github/copilot-instructions.local.md');
console.log('       — fill in the ## Project Context paragraph (1-2 sentences).');
console.log('       Identity grounding from session 1 beats grounding at session 10.');
console.log('');
console.log('    2. Open this workspace in VS Code with GitHub Copilot, then in a chat:');
console.log('         /welcome           — orientation tour (~2 min, read-only)');
console.log('         /configure-vscode  — apply user-scope VS Code settings (once per machine)');
console.log('');
console.log('    3. Start a real chat — describe what you want to build.');
console.log('');
